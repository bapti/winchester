...
const validateLocalOutput = (localOutputConfig) => {
  ...
  if (!hasLatency(localOutputConfigKeys)) throw new Error('Local requests must be specified')
  if (!isBool(localOutputConfig.latency)) throw new Error('Local requests must be a boolean')
