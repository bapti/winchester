...
const build404 = pageBuilder.build404
const buildGraph = pageBuilder.buildGraph
const buildIndex = pageBuilder.buildIndex

const scriptGenerator = require('./scriptGenerator')
const generateErrors = scriptGenerator.generateErrors
const generateLatency = scriptGenerator.generateLatency
const generateRequests = scriptGenerator.generateRequests
const generateThroughput = scriptGenerator.generateThroughput
const generateTimeouts = scriptGenerator.generateTimeouts

const writer = require('./writer')
const writeHtml = writer.writeHtml
const writeJs = writer.writeJs
